-- =========================================================
-- 0) Crear base de datos (si lo corres desde una BD distinta)
-- =========================================================
...
-- =========================================================
-- 2) Tipos ENUM
--    Ajusta los valores si en tu dump original tenías otros
-- =========================================================

DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'estado_academico') THEN
    CREATE TYPE estado_academico AS ENUM ('ACTIVO', 'BAJA', 'EGRESADO', 'SUSPENDIDO');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'estatus_inscripcion') THEN
    CREATE TYPE estatus_inscripcion AS ENUM ('INSCRITO', 'BAJA', 'PREINSCRITO');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'tipo_materia') THEN
    CREATE TYPE tipo_materia AS ENUM ('OBLIGATORIA', 'OPTATIVA', 'LIBRE');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'rol_docente') THEN
    CREATE TYPE rol_docente AS ENUM ('TITULAR', 'CO_TITULAR', 'AYUDANTE');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'severidad') THEN
    CREATE TYPE severidad AS ENUM ('INFO', 'WARN', 'ERROR', 'CRITICO');
  END IF;
END$$;
...
CREATE SEQUENCE IF NOT EXISTS public.alumno_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.alumno_grupo_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.archivo_cargado_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.asignacion_profesor_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.auditoria_cargas_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.calificacion_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.grupo_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.horario_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.incidencia_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.inscripcion_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.kardex_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.materia_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.migrations_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.optativa_progreso_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.periodo_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.plan_estudio_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.profesor_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.sancion_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.usuario_id_seq;
CREATE SEQUENCE IF NOT EXISTS public.validacion_resultado_id_seq;
...
CREATE TABLE IF NOT EXISTS public.archivo_cargado (
...
CREATE TABLE IF NOT EXISTS public.asignacion_profesor (
...
CREATE TABLE IF NOT EXISTS public.alumno_grupo (
...
CREATE TABLE IF NOT EXISTS public.auditoria_cargas (
...
CREATE TABLE IF NOT EXISTS public.validacion_resultado (
...
CREATE TABLE IF NOT EXISTS public.optativa_progreso (
...
-- =========================================================
-- 7) Función crear_usuario_con_password
-- =========================================================
...
-- =========================================================
-- 8) UPDATE de passwords de profesores (si ya hay datos)
-- =========================================================
